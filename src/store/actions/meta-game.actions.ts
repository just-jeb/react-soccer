...
export const MetaGameActions = {
  startNewGame: (
    startNodeId: string,
    defaultBoosters: TBoosters,
    goals: IGoal[],
    players: IPlayer[],
    nodes: INode[],
  ) =>
    createAction(EMetaGameActionsTypes.START_GAME, {
      startNodeId,
      defaultBoosters,
      goals,
      players,
  ...
  loadGame: (game: ISavedGame) =>
    createAction(EMetaGameActionsTypes.LOAD_GAME, game),
  saveGame: (game: ISavedGame) =>
    createAction(EMetaGameActionsTypes.SAVE_GAME, game),
